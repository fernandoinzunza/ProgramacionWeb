...
?>
    ...
    <?php foreach ($results as $data) { ?>
        ...
        <div class="block-4 text-center border" style="height:450px; width:275px;">
          ...
          <div class="block-4-text p-4">
              <h3><a href="shop_articulo?cod=<?php echo $data['codigo']?>" title="<?php echo $data['titulo'];?>" class="tituloLetra"><?php if(strlen($data['titulo'])>30){
              $cadena = "";
                  for($i = 0; $i<25;$i++)
                  {
